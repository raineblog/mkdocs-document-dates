...
- [x] 适用于任何环境：无 Git、Git 环境、Docker 容器、所有 CI/CD 构建系统等
- [x] 支持列表显示最近更新的文档（按更新日期倒序排列）
...
- [日期时间](https://jaywhj.netlify.app/document-dates-zh#%E6%97%A5%E6%9C%9F%E6%97%B6%E9%97%B4)：介绍了文档日期的获取机制以及个性化自定义的方法，支持手动指定每个文档的创建日期和最后更新日期
- [作者](https://jaywhj.netlify.app/document-dates-zh#%E4%BD%9C%E8%80%85)：介绍了文档作者的获取机制以及个性化自定义的方法，支持手动指定每个文档的作者信息，比如姓名、链接、头像、邮箱等
- [头像](https://jaywhj.netlify.app/document-dates-zh#%E5%A4%B4%E5%83%8F)：可手动指定每个作者的头像，支持本地文件路径、URL 路径
- [结构与样式](https://jaywhj.netlify.app/document-dates-zh#%E7%BB%93%E6%9E%84%E4%B8%8E%E6%A0%B7%E5%BC%8F)：可在 mkdocs.yml 或 Front Matter 中自由配置插件的显示结构；可通过预置入口快速设置插件样式，比如图标、主题、颜色、字体、动画、分界线等
